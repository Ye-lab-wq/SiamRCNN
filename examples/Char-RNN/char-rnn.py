...
class Model(ModelDesc):
    ...
    def build_graph(self, input, nextinput):
        ...
        def get_v(n):
            ret = tf.compat.v1.get_variable(n + '_unused', [param.batch_size, param.rnn_size],
                                  trainable=False,
        ...
        embeddingW = tf.compat.v1.get_variable('embedding', [param.vocab_size, param.rnn_size])
    ...
    def optimizer(self):
        lr = tf.compat.v1.get_variable('learning_rate', initializer=2e-3, trainable=False)
