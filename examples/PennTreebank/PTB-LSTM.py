...
class Model(ModelDesc):
    ...
    def build_graph(self, input, nextinput):
        ...
        def get_v(n):
            return tf.compat.v1.get_variable(n, [BATCH, HIDDEN_SIZE],
                                   trainable=False,
        ...
        embeddingW = tf.compat.v1.get_variable('embedding', [VOCAB_SIZE, HIDDEN_SIZE], initializer=initializer)
    ...
    def optimizer(self):
        lr = tf.compat.v1.get_variable('learning_rate', initializer=1.0, trainable=False)
